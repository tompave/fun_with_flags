defmodule FunWithFlags.EntryPoint do
  ...
  An entry point provides the public interface to the library. Its API
  consists of simple functions to enable, disable and query feature flags.

  In order to define an entry point, use this module inside your custom module:
  ...
  ## Example
      ...
      {:ok, true} = MyApp.Flags.enabled?(:my_named_flag)
