...
# -------------
  ...
  describe "all_flags() returns all the flags" do
    ...
    test "with saved flags in returns a list of flags" do
      ...
      Persistent.put(name1, g_1a)
      Persistent.put(name1, g_1b)
      Persistent.put(name1, g_1c)

      name2 = unique_atom()
      g_2a = Gate.new(:boolean, false)
      g_2b = Gate.new(:actor, "another actor", true)
      Persistent.put(name2, g_2a)
      Persistent.put(name2, g_2b)

      name3 = unique_atom()
      g_3a = Gate.new(:boolean, true)
      Persistent.put(name3, g_3a)

      result = Persistent.all_flags()
