...
* Updated `redix` and `redix_pubsub` dependencies.
* `FunWithFlags.all_flags/0` is now public, documented and tested.
* Added `FunWithFlags.all_flags_names/0`, public, documented and tested.
